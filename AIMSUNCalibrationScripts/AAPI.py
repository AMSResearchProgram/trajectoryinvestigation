...
def AKIActionAddCloseTurningODAction(sectionId, anewSection2Close, aOrigin, aDest, vehTypePos, acomplianceLevel, visibilityDistance=200.0, localEffect=True):
    return _AAPI.AKIActionAddCloseTurningODAction(sectionId, anewSection2Close, aOrigin, aDest, vehTypePos, acomplianceLevel, visibilityDistance, localEffect)
AKIActionAddCloseTurningODAction = _AAPI.AKIActionAddCloseTurningODAction

def AKIActionAddCloseTurningODActionByID(idAction, sectionId, anewSection2Close, aOrigin, aDest, vehType, acomplianceLevel, visibilityDistance=200.0, localEffect=True):
    return _AAPI.AKIActionAddCloseTurningODActionByID(idAction, sectionId, anewSection2Close, aOrigin, aDest, vehType, acomplianceLevel, visibilityDistance, localEffect)
...
class A2KSubPathProportion(_object):
    ...
    def __init__(self, *args):
        ...
        try:
            ...
            self.this = this
    __swig_setmethods__["nbSections"] = _AAPI.A2KSubPathProportion_nbSections_set
    __swig_getmethods__["nbSections"] = _AAPI.A2KSubPathProportion_nbSections_get
    if _newclass:
        nbSections = _swig_property(_AAPI.A2KSubPathProportion_nbSections_get, _AAPI.A2KSubPathProportion_nbSections_set)
    __swig_setmethods__["subpath"] = _AAPI.A2KSubPathProportion_subpath_set
    __swig_getmethods__["subpath"] = _AAPI.A2KSubPathProportion_subpath_get
    if _newclass:
        subpath = _swig_property(_AAPI.A2KSubPathProportion_subpath_get, _AAPI.A2KSubPathProportion_subpath_set)
    __swig_setmethods__["percentage"] = _AAPI.A2KSubPathProportion_percentage_set
    __swig_getmethods__["percentage"] = _AAPI.A2KSubPathProportion_percentage_get
    if _newclass:
        percentage = _swig_property(_AAPI.A2KSubPathProportion_percentage_get, _AAPI.A2KSubPathProportion_percentage_set)
...
class A2KDestinationProportion(_object):
    ...
    def __init__(self, *args):
        ...
        try:
            ...
            self.this = this
    __swig_setmethods__["newDest"] = _AAPI.A2KDestinationProportion_newDest_set
    __swig_getmethods__["newDest"] = _AAPI.A2KDestinationProportion_newDest_get
    if _newclass:
        newDest = _swig_property(_AAPI.A2KDestinationProportion_newDest_get, _AAPI.A2KDestinationProportion_newDest_set)
    __swig_setmethods__["percentage"] = _AAPI.A2KDestinationProportion_percentage_set
    __swig_getmethods__["percentage"] = _AAPI.A2KDestinationProportion_percentage_get
    if _newclass:
        percentage = _swig_property(_AAPI.A2KDestinationProportion_percentage_get, _AAPI.A2KDestinationProportion_percentage_set)
    __swig_setmethods__["nbSubpaths"] = _AAPI.A2KDestinationProportion_nbSubpaths_set
    __swig_getmethods__["nbSubpaths"] = _AAPI.A2KDestinationProportion_nbSubpaths_get
    if _newclass:
        nbSubpaths = _swig_property(_AAPI.A2KDestinationProportion_nbSubpaths_get, _AAPI.A2KDestinationProportion_nbSubpaths_set)
    __swig_setmethods__["subpaths"] = _AAPI.A2KDestinationProportion_subpaths_set
    __swig_getmethods__["subpaths"] = _AAPI.A2KDestinationProportion_subpaths_get
    if _newclass:
        subpaths = _swig_property(_AAPI.A2KDestinationProportion_subpaths_get, _AAPI.A2KDestinationProportion_subpaths_set)
...
def AKIActionAddForceTurningODActionByID(idAction, sectionId, nbNextSections, aNextSections, aOrigin, aDest, vehType, aSectionInPath, aComplianceLevel, visibilityDistance):
    return _AAPI.AKIActionAddForceTurningODActionByID(idAction, sectionId, nbNextSections, aNextSections, aOrigin, aDest, vehType, aSectionInPath, aComplianceLevel, visibilityDistance)
AKIActionAddForceTurningODActionByID = _AAPI.AKIActionAddForceTurningODActionByID

def AKIActionAddForceTurningODSubPathActionByID(idAction, sectionId, nbNextSections, aNextSections, aOrigin, aDest, vehType, aSectionInPath, aComplianceLevel, visibilityDistance):
    return _AAPI.AKIActionAddForceTurningODSubPathActionByID(idAction, sectionId, nbNextSections, aNextSections, aOrigin, aDest, vehType, aSectionInPath, aComplianceLevel, visibilityDistance)
AKIActionAddForceTurningODSubPathActionByID = _AAPI.AKIActionAddForceTurningODSubPathActionByID

def AKIActionAddForceTurningResultActionByID(idAction, sectionId, aOldNextSection, nbNewNextSections, aNewNextSections, vehType, aComplianceLevel):
    return _AAPI.AKIActionAddForceTurningResultActionByID(idAction, sectionId, aOldNextSection, nbNewNextSections, aNewNextSections, vehType, aComplianceLevel)
AKIActionAddForceTurningResultActionByID = _AAPI.AKIActionAddForceTurningResultActionByID

def AKIActionAddForceTurningResultSubPathActionByID(idAction, sectionId, nbNewNextSections, aNewNextSections, vehType, aComplianceLevel):
    return _AAPI.AKIActionAddForceTurningResultSubPathActionByID(idAction, sectionId, nbNewNextSections, aNewNextSections, vehType, aComplianceLevel)
AKIActionAddForceTurningResultSubPathActionByID = _AAPI.AKIActionAddForceTurningResultSubPathActionByID

def AKIActionAddChangeDestActionByID(idAction, sectionId, nbNextSections, aNewDests, aOrigin, aDest, vehType, aComplianceLevel):
    return _AAPI.AKIActionAddChangeDestActionByID(idAction, sectionId, nbNextSections, aNewDests, aOrigin, aDest, vehType, aComplianceLevel)
AKIActionAddChangeDestActionByID = _AAPI.AKIActionAddChangeDestActionByID

def AKIActionAddChangeDestParkRideActionByID(idAction, sectionId, nbNextSections, aNewDests, aOrigin, aDest, vehType, complianceLevel, scaleFactor):
    return _AAPI.AKIActionAddChangeDestParkRideActionByID(idAction, sectionId, nbNextSections, aNewDests, aOrigin, aDest, vehType, complianceLevel, scaleFactor)
